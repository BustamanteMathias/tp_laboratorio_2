...
namespace Entidades_2018
{
    ...
    public sealed class Changuito
    {
        ...
        /// <summary>
        /// Constructor de clase, se inicializara la lista
        /// </summary>
        private Changuito()
        {
        ...
        /// <summary>
        /// Se inicializara con una cantidad maxima de espacio disponible pasada como parametro
        /// </summary>
        /// <param name="espacioDisponible"> Cantidad maxima de espacio disponible para la lista </param>
        public Changuito(int espacioDisponible) : this()
        {
            if (espacioDisponible >= 0)
                this.espacioDisponible = espacioDisponible;
           
            this.productos = new List<Producto>(this.espacioDisponible);
        }
        #endregion
